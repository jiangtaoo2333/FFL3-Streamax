...
_C.MODEL.PRETRAINED = './models/hrnetv2_w18_imagenet_pretrained.pth'
_C.MODEL.NUM_JOINTS = 106
...
_C.DATASET = CN()
_C.DATASET.ROOT = ''
_C.DATASET.DATASET = 'FFL3'
_C.DATASET.TRAINSET = 'C:/temp/alignment106/FLL3_dataset/train/'
_C.DATASET.TESTSET = 'C:/temp/alignment106/FLL3_dataset/val/'
# todo  训练集、验证集划分
